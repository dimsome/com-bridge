...
// tesnets
import { hardhat, scrollSepolia, polygonZkEvmTestnet, mantleTestnet, sepolia, avalancheFuji } from "wagmi/chains";
// mainnets
...
const testnets = [sepolia, avalancheFuji, scrollSepolia, polygonZkEvmTestnet, mantleTestnet]
